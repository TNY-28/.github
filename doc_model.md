...
- `building/` no sube a Git → está en el `.gitignore` estándar de todo proyecto (regla en `git_method.md`) y se **respalda aparte** (OneDrive o repo privado). Es lo más valioso y sería lo único sin copia.
